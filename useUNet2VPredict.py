...
Listfile,allFilename = file_name('G:/SRSSNetKeras/ROCaccuracyEva/IMG10m/Sent2A');
for ii in range(len(Listfile)):
    savename = 'Unet10Add2VModel/' + allFilename[ii];
    print(savename);
    unetModel = load_model( zhuanyiPath +  '/saveSTModel/Unet10Add2VModel.h5');
